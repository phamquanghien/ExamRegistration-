...
namespace ExamRegistration.Controllers
{
    public class SubjectController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SubjectID,SubjectCode,SubjectName,IsActive")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("SubjectID,SubjectCode,SubjectName,IsActive")] Subject subject)
        {
